...
@Component({
  ...
  templateUrl: './detail-distpach.component.html',
  styleUrl: './detail-distpach.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DetailDistpachComponent {
  receivedData: any;
      ...
      this.StatusRequestService.updateStatusRequest(orderPayload).subscribe({
        next: (response) => {
          if (response.success) {
            ...
            this.router.navigate(['/planner/confirmed']);
          } else {
            Swal.fire({
              title: 'Advertencia',
              text: response.message,
  ...
  onEdit() {
    ...
    this.router.navigate(['/planner/edit-distpach'], {
