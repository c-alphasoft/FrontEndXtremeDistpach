...
@Component({
  ...
  templateUrl: './edit-distpach.component.html',
  styleUrl: './edit-distpach.component.scss',
})
export class EditDistpachComponent implements OnInit {
  eventForm: FormGroup;
  receivedData: any;
  ...
  onCancel() {
    ...
    this.router.navigate(['/planner/detail-distpach'], {
