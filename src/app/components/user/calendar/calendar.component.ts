...
export class CalendarComponent implements OnInit {
  ...
  loadOrdersByStatus(userEmail: string): void {
    this.orderService.getScheduledOrders(userEmail).subscribe(
      (data: Order[]) => {
  ...
  handleEvent(action: string, event: CalendarEvent): void {
    ...
    this.router.navigate(['/user/detail-dispatch'], {
      state: { datos: newData },
    });
  }
  ...
  addEvent(): void {
    ...
    this.router.navigate(['user/new-dispatch'], {
      state: { datos: newData },
    });
  }
