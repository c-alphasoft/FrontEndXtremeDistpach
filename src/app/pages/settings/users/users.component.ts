...
export class UsersComponent implements AfterViewInit {
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(UsersDialogContentComponent, {
      data: obj,
    });
...
export class UsersDialogContentComponent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UsersDialogContentComponent>,
